...
import { creditsCfg, effortCostOf, choiceCostOf, messageCost, peakMultiplierOf } from "@/lib/engagement/credits";
import type { AiChatConfig, AiChatChoice } from "@/lib/site/types";
