...
- **公开站点**
  ...
  - 文章：双视图 / 分类标签筛选 / 分页 + 阅读进度条；详情：Shiki 高亮、KaTeX、提示框、目录、原生评论（GitHub 登录）、点赞 + 朋友圈式头像列表、阅读量
  - 归档时间线、说说（含评论）、相册（拍立得照片墙 + 灯箱）、友链、关于、RSS、站内搜索、sitemap
...
- **管理后台 `/admin`**：Markdown 编辑器实时预览、文章 / 分类标签 / 说说 / **评论（审核/软删除/恢复）** / 友链 / 相册 / 音乐 / 站点配置全管理；仪表盘与数据统计含点赞 / 评论指标

## 技术栈

Next.js 16 (App Router) · React 19 · TypeScript · Tailwind CSS v4 · framer-motion · SQLite + Drizzle ORM · jose JWT（admin + GitHub 访客双会话） · unified/remark/rehype + Shiki · three.js · pixi.js + Live2D
