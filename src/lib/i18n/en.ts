...
export const en: Dictionary = {
  ...
  posts: {
    ...
    companionTitle: "Article companion",
    companionWelcome: "Anything about this article? I answer with the full text in context — follow-ups welcome.",
  ...
  chatPage: {
    ...
    guideStarters: [
      ...
      "I'm new here — give me a quick tour of this blog",
      "What's in the photo albums?",
      "Any good songs in the music room?",
      "What's new on the blog lately?",
      "What's this blog built with?",
      "I'm feeling a bit tired — keep me company for a moment",
    ...
    suggestions: [
      ...
      "What's in the photo albums?",
      "Describe this blog in one sentence",
      "Any interesting projects?",
      "How many posts are there now?",
      "Recommend a short read",
      "Tell me about the person behind this blog",
      "I'm feeling meh — say something fun",
      "Quiz me on a random CS fact",
      "One song worth putting on repeat lately?",
      "It's a lovely day — write a fitting line",
    ],
  },
  mascot: {
